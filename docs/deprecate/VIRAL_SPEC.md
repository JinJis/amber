...
## 2. V-1 · 차트가 박힌 서버사이드 OG 이미지 — ✅ done (2026-07-10)
...
## 3. V-2 · 네이티브 공유 + 공유 UX 마감 — ✅ done (2026-07-10; 아티클 우상단 진입점은 후속)
...
## 4. V-3 · 공유 페이지 캐시/성능 — ✅ done (2026-07-10)
...
## 5. V-4 · 공유 조회 측정 — ✅ done (2026-07-10; 어드민 랭킹 페이지는 후속)
...
## 6. V-5 · 공유 페이지 전환 루프 — ✅ done (2026-07-10)
...
## 10. V-9 · 온디맨드 공시 인제스트 — ✅ done (2026-07-10, filing_search 폴백 재사용)
