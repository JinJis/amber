...
|---|---|---|---|
| datasets | 148 | 316 (measured — EV-FIX 2026-07-11: gnews 리졸버·source_html 하한/v3·OpenDART 쿼터/로테이션·덱 재fetch·filing_type +42) | ✅ OPS-1 (+2 grouping/runner); then ≥32 HL-1/2/3, ≥12 HL-4, ≥9 HL-5, ≥22 QT-1/4, ≥7 EC-1, ≥14 FI-1/2/3, ≥8 HL-8/EC-2 |
