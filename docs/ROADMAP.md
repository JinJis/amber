...
- **Platform**: 6 services + worker, gateway-enforced entitlement/metering, Procrastinate
  queue, admin console, 537 unit tests (datasets 262 · agent-engine 140 · studio-api 76 · web 59), e2e/coverage/eval harnesses.
