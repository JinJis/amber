...
- **Platform**: 6 services + worker, gateway-enforced entitlement/metering, Procrastinate
  queue, admin console, 541 unit tests (datasets 262 · agent-engine 142 · studio-api 76 · web 61), e2e/coverage/eval harnesses.
